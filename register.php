    ...
    <div class="tab-content">
       ...
       <div class="tab-pane container active" id="hospitals">
        ...
        <form action="file/hospitalReg.php" method="post" enctype="multipart/form-data">
          ...
          <input type="text" name="hcity" placeholder="Blood Bank City" class="form-control mb-3" required>
          <input type="tel" name="hphone" placeholder="Blood Bank Phone Number" class="form-control mb-3" required>
          <input type="email" name="hemail" placeholder="Blood Bank Email" class="form-control mb-3" required>
