				...
				<div class="card">
					...
					<div class="card-body">
					   <form action="file/updateprofile.php" method="post">
						...
						<label class="text-muted font-weight-bold">Blood Bank Email</label>
						...
						<label class="text-muted font-weight-bold">Blood Bank Phone Number</label>
						<input type="text" name="hphone" value="<?php echo $row['hphone']; ?>" class="form-control mb-3">
						<label class="text-muted font-weight-bold">Blood Bank City</label>
